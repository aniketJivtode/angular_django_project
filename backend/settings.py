...
SECRET_KEY = 'django-insecure-i7e4kn0g0k-9w=8qjq8ml=u8njtwz11z0m7us*z+$&2o+j5$53'
...
if 'APP_URL' in os.environ:
    ...
    MEDIA_URL = "https://" + APP_URL + "/media/"
    STATIC_URL = "https://" + APP_URL + '/backend/static/'
else:
    # APP_URL = "http://127.0.0.1:3000/register"
    MEDIA_URL = '/media/'
...
if 'APP_URL' in os.environ:
    X_FRAME_OPTIONS = 'ALLOW-FROM ' + str(os.environ['APP_URL'])
else:
    X_FRAME_OPTIONS = 'ALLOW-FROM 127.0.0.1:3000'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'vision_server',  # db name
        'USER': 'root',
        'PASSWORD': 'Kevision1234',
...
AUTH_USER_MODEL = 'usermanagement.User_Management'
...
SWAGGER_SETTINGS = {
    ...
    'DEFAULT_AUTO_SCHEMA_CLASS':
        'backend.swagger.generators.ReadWriteAutoSchema'
}
